...
$scriptPath = "C:\Users\kyleh\.gemini\BotProject\farm_cycle.py"
$taskName = "FarmCycle"
...
Start-Process -FilePath $pythonExe -ArgumentList $scriptPath -WorkingDirectory "C:\Users\kyleh\.gemini\BotProject"
